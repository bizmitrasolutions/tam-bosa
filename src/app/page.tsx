      ...
      <section className="relative h-screen flex flex-col justify-center overflow-hidden">
        ...
        >
          ...
          <motion.h2
            ...
            className="text-[11vw] md:text-[8vw] leading-[1] font-serif text-primary-soft tracking-tighter uppercase relative z-20 flex flex-col items-center"
          >
            <span>TAM-BOSA</span>
            <span className="text-foreground text-[8vw] md:text-[6vw] md:ml-[15vw] inline-block mt-2 md:mt-[-1vw]">BEACH SIDE STAY</span>
          </motion.h2>
          <motion.p
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
